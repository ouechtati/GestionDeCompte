...
public class GestionDesComptesApplication implements CommandLineRunner{
	...
	public void run(String... arg0) throws Exception {	
		Client c1 = clientRepository.save(new Client("marouene", "marouene@gmail.com"))	;	
		Client c2 = clientRepository.save(new Client("marouene", "ouechtati@gmail.com"))	;
		Client client = clientRepository.save(new Client("marouene ouechtati", "marouene.ouechtati@gmail.com"));
//		
